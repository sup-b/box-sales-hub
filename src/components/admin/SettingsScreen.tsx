...
const items = [
  { icon: Store, label: "Thông tin cửa hàng", desc: "Tên, địa chỉ, liên hệ" },
  { icon: Bell, label: "Thông báo", desc: "Cảnh báo tồn kho, đơn hàng mới" },
  { icon: Shield, label: "Bảo mật", desc: "Mật khẩu, quyền truy cập" },
];
